      ...
      state.funcs = [
        {
          ...
          options: [
            ...
            //{ code:"solid([1,0,0],[0,1,0],[0,0,1])", ai: false},
            { code: "shape(3)", ai: false}, 
            { code: "shape(5)", ai: false},
